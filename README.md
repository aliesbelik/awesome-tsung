...
- [Tsung: Load testing of web applications](https://habr.com/en/post/132459/) - Tsung: Нагрузочное тестирование Web-приложений *(Russian)*.
...
- [Custom Tsung plugin](http://lin-techdet.blogspot.com/2013/04/tsung.html) - Собственный плагин tsung *(Russian)*.
